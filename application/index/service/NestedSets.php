...
class NestedSets {
	 ...
	 *
	 * @access public
	 * @param 实现了Admin\Logic\DbMysql 类的 对象
	 ...
	 * @return void
	 */
	public function __construct($Db, $table_name, $left_key = null, $right_key = null, $parent_key = null, $primary_key = null, $level_key = null) {
		$this->Db = $Db;
